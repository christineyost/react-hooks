...
- **Managed state** - state that is actively managed. It is created using
  `React.useState()`
- **Derived state** - state that is derived from managed and/or other derived
  state
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=04%3A%20useState%3A%20tic%20tac%20toe&em=yost90%40gmail.com).
