...
- Most of this section was similar to when we used the useState hook in the
  `react-fundamentals` workshop
- Calling a state setter causes the component to be re-rendered which allows it
  to show updated information
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=yost90%40gmail.com).
